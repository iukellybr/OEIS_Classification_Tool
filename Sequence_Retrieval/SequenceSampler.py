...
# this script generates samples within each sequence by partitioning them, e.g. taking only the first third of a given sequence
# it is more of an exploratory/optional processing step as opposed to something that our team pursued in depth
